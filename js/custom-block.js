(function (blocks, element, editor, components) {
  ...
  //team section
//   blocks.registerBlockType("myplugin/feature-section", {
...
//         sectionDescription: { type: "string", default: "Why Choose Us? Get Your Life Style Back" },
//         features: {
//             type: "array",
//             default: [
//                 {
...
//             ],
//         },
//         buttonText: { type: "string", default: "More Details" },
...
//         function updateSectionDescription(value) {
//             props.setAttributes({ sectionDescription: value });
//         }

//         function updateFeature(index, key, value) {
//             const updatedFeatures = [...attributes.features];
//             updatedFeatures[index][key] = value;
//             props.setAttributes({ features: updatedFeatures });
//         }
...
//             };
//             props.setAttributes({ features: [...attributes.features, newFeature] });
//         }
...
//             el(
//                 "div",
//                 { className: "feature-section-editor" },
//                 el("h2", {}, "Edit Feature Section"),
//                 el(
//                     "div",
...
//                         el(
//                             "div",
//                             { className: "feature-item-editor", key: index },
//                             el(TextControl, {
//                                 label: "Icon Class",
//                                 value: feature.icon,
...
//                     el(
//                         "button",
//                         { className: "add-feature-button", onClick: addFeature },
//                         "Add Feature"
//                     )
//                 )
//             )
...
//                     el("h4", { className: "sub-title px-3 mb-0" }, attributes.sectionTitle),
//                     el("h1", { className: "display-3 mb-4" }, attributes.sectionTitle),
//                     el("p", { className: "mb-0" }, attributes.sectionDescription)
//                 ),
//                 el(
//                     "div",
...
//                         el(
//                             "div",
//                             { className: "col-md-6 col-lg-4 col-xl-3", key: index },
//                             el(
//                                 "div",
...
//                                     el(
//                                         "div",
//                                         { className: "p-3 d-inline-flex bg-white rounded" },
//                                         el("i", { className: `${feature.icon} fa-4x text-primary` })
//                                     )
//                                 ),
//                                 el(
//                                     "div",
//                                     { className: "feature-content d-flex flex-column" },
//                                     el("h5", { className: "mb-4" }, feature.title),
//                                     el("p", { className: "mb-0" }, feature.description)
//                                 )
//                             )
//                         )
//                     )
...
//                     el(
//                         "a",
//                         { href: attributes.buttonLink, className: "btn btn-primary rounded-pill text-white py-3 px-5" },
